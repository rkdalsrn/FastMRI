...
class UNet(nn.Module):
    def __init__(self, img_ch=3, output_ch=1,deepsupervision=False):
        super().__init__()
        ...
        self.final = nn.Conv2d(nb_filter[0], output_ch, kernel_size=1,stride=1,padding=0)
...
class NestedUNet(nn.Module):
    def __init__(self, input_ch = 1, output_ch = 1, deepsupervision=False):
        super().__init__()
        ...
        self.conv0_0 = VGGBlock(input_ch, nb_filter[0], nb_filter[0])
        self.conv1_0 = VGGBlock(nb_filter[0], nb_filter[1], nb_filter[1])
        self.conv2_0 = VGGBlock(nb_filter[1], nb_filter[2], nb_filter[2])
        self.conv3_0 = VGGBlock(nb_filter[2], nb_filter[3], nb_filter[3])
        self.conv4_0 = VGGBlock(nb_filter[3], nb_filter[4], nb_filter[4])
