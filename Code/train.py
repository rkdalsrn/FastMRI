...
def parse():
    ...
    parser.add_argument('-e', '--num-epochs', type=int, default=70, help='Number of epochs')
    ...
    parser.add_argument('-v', '--data-path-val', type=Path, default='../Data/image_Leaderboard/', help='Directory of validation data')
